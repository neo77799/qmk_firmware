...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_Z,    KC_X,   KC_C,  KC_V,  KC_B,       KC_N,  KC_M,   KC_COMM,  KC_DOT,   KC_SLSH,          KC_RSFT, KC_FN,
    KC_LCTL, KC_LALT, KC_SPACE,                         KC_FN, KC_SPACE,         KC_RALT,  KC_RCTL
  ),
  [_FN] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,       KC_PGDOWN, KC_HOME, KC_END,   _______,  _______,              KC_RSHIFT, KC_FN,
