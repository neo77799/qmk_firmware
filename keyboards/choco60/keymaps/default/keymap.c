...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTRL,  KC_LALT, KC_SPACE, KC_FN, KC_SPACE, KC_RALT, KC_RCTRL
  ),
  [_FN] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, KC_ENTER,
